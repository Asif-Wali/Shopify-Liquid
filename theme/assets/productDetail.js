...
// Disclaimer section
{
  function toggleDisclaimer1() {
    ...
    if (
      ...
      Disclaimer1content.style.display === ""
    ) {
  ...
  function toggleDisclaimer2() {
    ...
    if (
      ...
      Disclaimer2content.style.display === ""
    ) {
  ...
  function toggleDisclaimer3() {
    ...
    if (
      ...
      Disclaimer3content.style.display === ""
    ) {
  ...
  function toggleDisclaimer4() {
    ...
    if (
      ...
      Disclaimer4content.style.display === ""
    ) {
...
// Ask Disclaimer section
{
  function toggleAskDisclaimer1() {
    let AskDisclaimer1content = document.getElementById(
      "AskDisclaimer1content"
    );

    if (
      AskDisclaimer1content.style.display === "none" ||
      AskDisclaimer1content.style.display === ""
    ) {
  ...
  let AskDisclaimer1ToggleButton = document.getElementById(
    "AskDisclaimer1Toggle"
  );
  AskDisclaimer1ToggleButton.addEventListener("click", toggleAskDisclaimer1);

  function toggleAskDisclaimer2() {
    let AskDisclaimer2content = document.getElementById(
      "AskDisclaimer2content"
    );

    if (
      AskDisclaimer2content.style.display === "none" ||
      AskDisclaimer2content.style.display === ""
    ) {
  ...
  let AskDisclaimer2ToggleButton = document.getElementById(
    "AskDisclaimer2Toggle"
  );
  AskDisclaimer2ToggleButton.addEventListener("click", toggleAskDisclaimer2);

  function toggleAskDisclaimer3() {
    let AskDisclaimer3content = document.getElementById(
      "AskDisclaimer3content"
    );

    if (
      AskDisclaimer3content.style.display === "none" ||
      AskDisclaimer3content.style.display === ""
    ) {
  ...
  let AskDisclaimer3ToggleButton = document.getElementById(
    "AskDisclaimer3Toggle"
  );
  AskDisclaimer3ToggleButton.addEventListener("click", toggleAskDisclaimer3);

  function toggleAskDisclaimer4() {
    let AskDisclaimer4content = document.getElementById(
      "AskDisclaimer4content"
    );

    if (
      AskDisclaimer4content.style.display === "none" ||
      AskDisclaimer4content.style.display === ""
    ) {
  ...
  let AskDisclaimer4ToggleButton = document.getElementById(
    "AskDisclaimer4Toggle"
  );
